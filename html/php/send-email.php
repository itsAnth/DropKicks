<?php
	// Your Email
	$recipient = "hello@dropkicks.org"; // PLEASE SET THE EMAIL ADDRESS of recipient
	$recipient_name = "DropKicks Web Form"; // PLEASE SET THE NAME OF the email address holder
	$subject_title = "New message from DropKicks"; //
